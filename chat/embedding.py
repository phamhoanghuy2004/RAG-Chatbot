...
def create_hybrid_retriever(source, id_key="doc_id", k=5, weights=[0.7, 0.3]):  # Increased default k
    """
...
def create_retriever_multivector (source, id_key = "doc_id", k = 5):  # Increased default k
    check_collection ()
